...
try
{
    ...
    jsonResponse.each { vra ->
        ...
        output('Status', vra.Status, wildValue)
        output('ProtectedVpgs', vra.ProtectedCounters.Vpgs, wildValue)
        output('ProtectedVms', vra.ProtectedCounters.Vms, wildValue)
        output('ProtectedVolumes', vra.ProtectedCounters.Volumes, wildValue)
        output('RecoveryVpgs', vra.RecoveryCounters.Vpgs, wildValue)
        output('RecoveryVms', vra.RecoveryCounters.Vms, wildValue)
        output('RecoveryVolumes', vra.RecoveryCounters.Volumes, wildValue)
        output('SelfProtectedVpgs', vra.SelfProtectedVpgs, wildValue)
        output('VraAlertsStatus', vra.VraAlerts.VraAlertsStatus, wildValue)
    }
